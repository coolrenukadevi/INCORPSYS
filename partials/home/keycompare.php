...
$kcCell = function (string $k, string $ck) use ($cmp, $pages, $kc, $dependent): string {
  ...
  if ($c && isset($pages[$c['guide']])) {
    ...
    return '<a class="kc-cell" href="'.e(path_url($c['guide'])).'" title="'.e($c['value']).'"><span class="kc-st kc-ok">'.icon('check').'</span><span class="kc-t">'.e($label).'</span><span class="visually-hidden">: '.e($c['value']).' (source guide)</span></a>';
  }
  if (in_array($ck, ['fees', 'timeline'], true) && isset($dependent[$k])) return '<span class="kc-cell"><span class="kc-st kc-dep" aria-hidden="true"></span><span class="kc-t">'.e($dependent[$k]).'</span></span>';
  return '<span class="kc-cell kc-muted"><span class="kc-st kc-nv" aria-hidden="true"></span><span class="kc-t">Not yet verified</span></span>';
};
...
<section class="section hs-keycmp" aria-labelledby="kc-title"><div class="container">
  ...
  <div class="kc-grid">
    <div class="kc-main">
      ...
      <ul class="kc-legend" aria-label="Legend"><li><span class="kc-st kc-ok"><?=icon('check')?></span>From the official source (select for details)</li><li><span class="kc-st kc-dep"></span>Depends on state or emirate</li><li><span class="kc-st kc-nv"></span>Not yet verified</li></ul>
