...
// Who decides, restated from each service's own answer text (content/services.php).
$controls=['company-incorporation'=>'The companies registry of the jurisdiction decides incorporation — for example ACRA, the Companies Registry, Companies House or SSM.','business-licensing'=>'The licensing authority for your activity, which is often different from the registry.','corporate-banking'=>'The bank. Each bank sets and applies its own account-opening requirements and makes its own decision.','compliance-documentation'=>'The registry and any authority that issued a licence or approval set the filing obligations.','visa-residency'=>'The immigration authority of the jurisdiction, under its own rules — separate from company registration.','ongoing-support'=>'The registry, the tax authority and any licensing authority, depending on the obligation.','registered-office-solutions'=>'The registry, and the licensing authority where the address is tied to the licence.','tax-registration'=>'The tax authority of the jurisdiction, not the companies registry.','due-diligence'=>'Official registries and the authorities whose records a claim relies on.','business-expansion'=>'The registry and licensing authorities of each new market, checked separately.'];
$process=[['Confirm the authority and route','Identify which authority controls each step for your jurisdiction and structure.'],['Check current requirements','Read the authority\'s current published guidance before any preparation starts.'],['Prepare','Build documents and information from the authority\'s own list.'],['Submit and keep evidence','File through the official channel and keep proof of submission and outcome.']];
$excluded=['Legal, tax or immigration advice','Decisions by registries, banks, licensing or immigration authorities','Guaranteed approval or processing times','Government fees — quoted separately, with their official source'];
include __DIR__.'/../partials/header.php';?>
<main id="main">
...
<section class="content-body"><div class="container layout-aside">
  <div class="content-main">
    ...
    <section class="content-section" aria-labelledby="excluded"><h2 id="excluded">What is not included</h2><ul class="check-list excluded"><?php foreach($excluded as $b):?><li><?=icon('x')?><span><?=e($b)?></span></li><?php endforeach;?></ul></section>
    ...
    <section class="content-section" aria-labelledby="cost"><h2 id="cost">Costs and timelines</h2><div class="alert alert-warning"><?=icon('triangle-alert')?><div><strong>No invented figures</strong>Government fees and processing times are set by each authority and change. We show the official source for every government fee.</div></div><div class="fee-contact"><div><strong>INCORPSYS service fee</strong><p>Quoted for your jurisdiction, structure and scope, separately from government fees.</p></div><a class="btn btn-cta" href="/get-started/">Contact for Service Fee<?=icon('arrow-right')?></a></div></section>
