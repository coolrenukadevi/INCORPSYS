...
$page=['slug'=>$hub,'title'=>'Company Formation in '.$label.' | INCORPSYS','description'=>'Company formation in '.$label.': structures, requirements, documents, registration steps and licensing, sourced from '.$auth.' guidance.'];
