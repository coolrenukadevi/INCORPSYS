...
<section class="content-body"><div class="container wizard">
  <ol class="wizard-progress" aria-label="Enquiry steps"><?php foreach($steps as $i=>$s):?><li><span><?=e($s)?></span></li><?php endforeach;?></ol>
  <form class="wizard-card" method="post" action="/enquiry/submit.php" data-wizard novalidate>
    ...
    <fieldset class="wizard-step"><legend><span class="wizard-count">Step 1 of 8</span>What do you need help with?</legend><p class="step-help">Choose the closest match. You can add detail later.</p><?=$choices('need',ENQUIRY_OPTIONS['need'])?></fieldset>
    <fieldset class="wizard-step"><legend><span class="wizard-count">Step 2 of 8</span>Which jurisdiction?</legend><p class="step-help">Not decided? Choose "Not decided yet" and we will help you compare.</p><?=$choices('country',$countries)?></fieldset>
    <fieldset class="wizard-step"><legend><span class="wizard-count">Step 3 of 8</span>What will the business do?</legend><p class="step-help">Activity decides licences and approvals, so this matters.</p><?=$choices('activity',ENQUIRY_OPTIONS['activity'])?>
    ...
    <fieldset class="wizard-step"><legend><span class="wizard-count">Step 4 of 8</span>Who will own the business?</legend><p class="step-help">Ownership can change which structures and rules apply.</p><?=$choices('ownership',ENQUIRY_OPTIONS['ownership'])?>
    ...
    <fieldset class="wizard-step"><legend><span class="wizard-count">Step 5 of 8</span>Will anyone need a visa or residency?</legend><p class="step-help">Immigration is a separate process from incorporation, decided by the immigration authority.</p><?=$choices('visa',ENQUIRY_OPTIONS['visa'])?></fieldset>
    <fieldset class="wizard-step"><legend><span class="wizard-count">Step 6 of 8</span>When do you want to start?</legend><p class="step-help">This helps us prioritise. It is not a promise of processing time.</p><?=$choices('timeline',ENQUIRY_OPTIONS['timeline'])?></fieldset>
    <fieldset class="wizard-step"><legend><span class="wizard-count">Step 7 of 8</span>How can we reach you?</legend><p class="step-help">We use these details only to reply to this enquiry.</p>
      <div class="form-grid">
    ...
    <fieldset class="wizard-step"><legend><span class="wizard-count">Step 8 of 8</span>Documents and anything else</legend>
