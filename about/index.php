...
$faqs=[['q'=>'What is INCORPSYS?','a'=>'INCORPSYS (Incorporation System) is a corporate infrastructure platform that replaces complex, manual registration processes with an end-to-end digital workflow for entity setup, document verification and government filings.'],['q'=>'Where does INCORPSYS work?','a'=>'INCORPSYS publishes guides for the UAE, Singapore, Hong Kong, the UK, the USA and Malaysia, and accepts enquiries for Saudi Arabia, the Philippines and Thailand while their guides are prepared.'],['q'=>'Is INCORPSYS a government authority?','a'=>'No. INCORPSYS is a private service provider. Registries, licensing, tax and immigration authorities make the final decisions.']];
...
<section class="content-body"><div class="container layout-aside">
  <div class="content-main">
    ...
    <section class="content-section" aria-labelledby="where"><h2 id="where">Where we work</h2><p>INCORPSYS supports company setup and corporate services in the UAE, Singapore, Hong Kong, the United Kingdom, the United States and Malaysia, and accepts enquiries for Saudi Arabia, the Philippines and Thailand while their guides are prepared.</p>
      <ul class="link-list"><?php foreach(site_registry()['sources']+site_registry()['pending'] as $k=>$s):?><li><a href="<?=e(path_url($k))?>"><?=icon('chevron-right')?><?=e($s['label'])?></a></li><?php endforeach;?></ul></section>
