...
<p>Where a value — a fee, a processing time, a threshold — has not been confirmed from the authority, we do not estimate it. Comparison tables show <strong>Verify</strong>, and cost sections direct you to the authority's current fee schedule.</p>
